<template>
	...
	<div v-else class="cursor-pointer flex text-sm gap-2 items-center place-self-end ">
		<!-- Twitter -->
		<a :href="twitterUrl" target="_blank">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18" fill="#7c54b4">
