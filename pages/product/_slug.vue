<template>
  <main class="container py-4 relative">
    ...
    <div class="block border border-[#e6e6e6] overflow-hidden bg-white shadow rounded-2xl box-border md:rounded-4xl">
        ...
        <div class="p-4 sm:p-5 md:p-0">
          ...
          <form @submit.prevent="triggerAddToCart">
            ...
            <div class="flex">
              <AddToCartButton
                ...
                :disabled="(!activeVariation && product.variations) || type.stockStatus == `OUT_OF_STOCK`"
                :class="{
            ...
            <div class="flex justify-between">
              <div class="text-xs text-true-gray-900 sm:text-sm md:text-xs lg:text-sm">
                <div class="flex items-center justify-center gap-2">
                  <svg width="1.5rem" fill="#0bc15c" viewBox="0 0 24 24">
                  ...
                  <div class="text-[#666]">If you order within <span class="text-[#333] font-semibold">{{countdown}}</span>, it will be delivered <span class="text-[#0bc15c] font-semibold">tomorrow </span>at the latest!</div>
                </div>
              </div>
            </div>
          </aside>
          ...
          <div>
            ...
            <div class="description leading-7 overflow-hidden max-h-84 text-sm text-[#666] sm:max-h-72 md:(max-h-48 text-xs text-[#333] leading-7) lg:(max-h-86 text-sm leading-8)">
              <ul>
                <li>Free returns within 30 days. Click for detailed <a class="underline" href="#">information</a>.</li>
                <li>This product will be sent by <span class="underline font-semibold cursor-help">WooNuxt</span>.</li>
                <div v-html="product.description"></div>
                <li>A maximum of 10 orders can be placed for this product. WooNuxt reserves the right to cancel orders over 10 units.</li>
                <li>More than 50 stocks were offered to be sold at the campaign price.</li>
                <li>WooNuxt determines the sales price of the product you have examined.</li>
